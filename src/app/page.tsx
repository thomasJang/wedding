          ...
          <div className='inr basic light'>
            <div className='row-01'>
              <div className='g-wrap' data-linkname='main_text_on_23'>
                <span className='g' data-linkname='main_cus_text_23'>
                  장기영
                </span>
                <span className='g dot' data-linkname='main_cus_text_24'>
                  ♥
                </span>
                <span className='g' data-linkname='main_cus_text_25'>
                  구소라
                </span>
              </div>
              <div data-linkname='main_text_on_26'>
                <div className='g2-wrap' data-linkname='main_cus_text_26'>
                  2025년 5월 31일 토요일, 낮 12시 <br />
                  한성교회(한성중화기독교회)
                </div>
              </div>
            ...
            <div className='sectionMg introLayer'>
              <div className='sectionHead anibox'>
                ...
                <span className='name' data-linkname='introTitle'>
                  소중한 분들을 초대합니다
                </span>
              </div>
            ...
            <div className='sectionMg layer layer03 ly_waytocome clearfix waytocomeSection'>
              <div className='sectionHead anibox'>
                ...
                <span className='name' data-linkname='mapTitle'>
                  오시는 길
                </span>
              </div>
              ...
              <div className='location_wrapper'>
                ...
                <div className='tbox road' data-linkname='hallLocation'>
                  서울 중구 정동길 8
                </div>
                <div className='tbox tel'>
                  <a className='tel' href='' data-linkname='hallTel'></a>
                </div>
              </div>
